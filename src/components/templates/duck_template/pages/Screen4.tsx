...
export default function Screen4({ card }: Screen4Props) {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-full bg-primary rounded-xl text-xl text-center md:text-left gap-8 p-6 md:p-8 overflow-hidden">
      {/* IMAGE SECTION */}
      <div className="flex items-center justify-center w-full md:basis-1/2 max-h-[80vh] overflow-hidden rounded-xl bg-black">
        <img
      ...
      <div
        className={cn(
          "flex flex-col gap-4 w-full h-full justify-between md:justify-center items-center md:items-start md:gap-12 md:p-4 md:basis-1/2 overflow-y-auto",
